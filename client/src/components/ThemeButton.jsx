...
export default function ThemeButton() {
  ...
  return (
    <>
        <motion.div className='w-[60px] h-[60px] absolute rounded-full bg-slate-950 bottom-8 right-12 z-50 shadow-2xl flex items-center justify-center cursor-pointer dark:bg-white'
